...
return '<p><a style="font-size:18px;font-weight:bold;" href="https://twitter.com/hashtag/RADIO87?vertical=default&amp;f=tweets" target="_blank" title="RADIO87.FR : Hashtag #RADIO87 sur Twitter !">RADIO87.FR : Hashtag #RADIO87 sur Twitter !</a></p>';
}
add_shortcode('RADIO87HASHTAGTWITTER', 'radio87hashtagtwitter');


function suivezlatortuehashtagtwitter() {
return '<p><a style="font-size:18px;font-weight:bold;" href="https://twitter.com/hashtag/SuivezlaTortue?vertical=default&amp;f=tweets" target="_blank" title="SuivezlaTortue de RADIO87.FR : Hashtag #SuivezlaTortue sur Twitter !">SuivezlaTortue de RADIO87.FR : Hashtag #SuivezlaTortue sur Twitter !</a></p>';
}
add_shortcode('SUIVEZLATORTUEHASHTAGTWITTER', 'suivezlatortuehashtagtwitter');


function radio87chat() {
return '<p><span style="font-size:18px;font-weight:bold;"><a style="font-size:18px;font-weight:bold;" href="http://www.radio87.fr/chat/" title="RADIO87 - Chat" target="_blank">Dialoguer</a> sur le salon de discussion de RADIO87.FR</span></p>';
}
